...
public class MyRunAsManagerImpl extends RunAsManagerImpl {
	...
	public Authentication buildRunAs(Authentication authentication, Object object, Collection<ConfigAttribute> attributes) {
		...
		org.springframework.security.core.userdetails.User principal = new org.springframework.security.core.userdetails.User(user.getLogin(), "", true, true, true, true, user.getAuthorities());
		return new RunAsUserToken(this.getKey(), principal, null, user.getAuthorities(), authentication.getClass());
	}
